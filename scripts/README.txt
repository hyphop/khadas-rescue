...
+ sd/                      - sd folder descriptions
+ clean                    - clean share
+ cmd2scr                  - uboot cmd script mkimage wrapper
+ image2flash              - write image to block dev (sd/mmc/usb flash card)
...
+ prepare_from_bins_vim2   - preprage from bins vim2
+ prepare_from_bins_vim3   - prepare from bin vim3
...
+ prepare_sd_image_rescue_vim2 - prerape rescue image for sd/usb/mmc disk - vfat
+ prepare_sd_image_rescue_vim2_spi - prerape rescue image for sd/usb/mmc disk - vfat - spi
+ prepare_sd_image_rescue_vim2_uboots - prerape rescue image for sd/usb/mmc disk - vfat - uboots 
